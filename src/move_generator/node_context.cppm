export module prodigy.move_generator:node_context;
...
struct NodeContext {
  ...
  consteval NodeContext move(const Move move = Move::OTHER) const noexcept {
    return {
  ...
  friend consteval bool operator==(NodeContext, NodeContext) = default;
